...
parser.add_argument('-z', '--zabbix', action='store_true', help='Send output to zabbix')
parser.add_argument('-q', '--quiet', action='store_true', help='Be quiet (do not print to stdout)')
